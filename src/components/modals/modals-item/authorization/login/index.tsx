...
const Login: React.FC = () => {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl p-8">
          <div className="text-center mb-8">
            <p className="text-gray-500 mt-2">Enter your username and password to login.</p>
          </div>

       <Form onFinish={login} className="space-y-6" layout="vertical">
  <Form.Item
    name="email"
  ...
  <Form.Item
    name="password"
    label={<span className="text-sm font-medium text-gray-700">Parol</span>}
  ...
  <div className="flex items-center justify-between">
    ...
    <a href="#" className="text-sm text-[#46A358] hover:text-green-700 font-medium">
  ...
  <button
    type="submit" 
    disabled={isPending}
    className="w-full bg-[#46A358] text-white py-3 rounded-lg font-semibold hover:bg-green-700 transform hover:scale-[1.02] transition duration-200 shadow-lg flex justify-center items-center disabled:opacity-50"
  >
    {isPending ? <Loader className="animate-spin w-6 h-6" /> : "Login"}
  </button>
</Form>
